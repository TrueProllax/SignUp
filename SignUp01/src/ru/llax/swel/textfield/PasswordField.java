package ru.llax.swel.textfield;
...
public class PasswordField extends JPasswordField {
    ...
    public PasswordField() {
        ...
        eye = new ImageIcon(getClass().getResource("/ru/llax/swel/textfield/eye.png")).getImage();
        eye_hide = new ImageIcon(getClass().getResource("/ru/llax/swel/textfield/eye_hide.png")).getImage();
